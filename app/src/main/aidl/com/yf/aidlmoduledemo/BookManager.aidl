// BookManager.aidl
package com.yf.aidlmoduledemo;

// Declare any non-default types here with import statements

import com.yf.aidlmoduledemo.bean.Book;//必须导入全称
import com.yf.aidlmoduledemo.ICallBack;
...
/**
  ...
  Book getBook(int bookId);//基本数据类型不用声明Tag(数据的流向)，默认是in

  void updateBook(in Book book);

  void addBook(in Book newBook);

  void removeBook(in Book bookRemoved);
